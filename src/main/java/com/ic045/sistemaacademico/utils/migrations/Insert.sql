...
INSERT INTO `disciplina` (id_curso, nome, codigo, ementa, pre_requisitos,  area, observacao, ch, semestre)
VALUES (1, 'Programação Orientada a Objetos', 'POOA', 'Ementa da disciplina de Programação Orientada a Objetos', 'Nenhum', 'Técnica', '', 40, 1);
