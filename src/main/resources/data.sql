...
INSERT INTO `disciplina` (id_curso, nome, codigo, ementa, pre_requisitos,  area, observacao, ch, ch_teorica, ch_pratica, semestre)
VALUES (1, 'Programação Orientada a Objetos', 'POOA', 'Ementa da disciplina de Programação Orientada a Objetos', 'Nenhum', 'Técnica', '', 60, 40, 20, 1);
