...
INSERT INTO `disciplina` (id_curso, nome, codigo, ementa, pre_requisitos, nivel, area, observacao, ch, semestre)
VALUES (1, 'Programação Orientada a Objetos', 'POOA', 'Ementa da disciplina de Programação Orientada a Objetos', 'Nenhum', 'Básico', 'Técnica', '', 40, 1);
